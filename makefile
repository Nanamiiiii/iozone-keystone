...
riscv_keystone_adm: iozone_riscv_keystone_adm.o libbif.o
	$(CCRV) -o $(LDFLAGS) -static iozone_riscv_keystone_adm.o libbif.o $(KEYSTONE_SDK)/lib/libkeystone-edge.a $(KEYSTONE_SDK)/lib/libkeystone-app-syscall.a -o iozone-adm
...
iozone_riscv_musl.o: iozone.c libbif.c
	...
	@echo ""
	$(CCRV) -c -O0 -Wno-implicit-function-declaration -Dgeneric -Dunix -DHAVE_ANSIC_C -DNO_THREADS -DNO_SOCKET -DNO_FORK -DNO_MADVISE -DNO_SIGNAL -DRISCV_RTC_1M \
...
iozone_riscv_keystone_adm.o: iozone.c libbif.c
	...
	@echo ""
	$(CCRV) -c -O0 -Wno-implicit-function-declaration -Dgeneric -Dunix -DHAVE_ANSIC_C -DNO_THREADS -DNO_SOCKET -DNO_FORK -DNO_MADVISE -DNO_SIGNAL -DRISCV_RTC_1M -DADM_MALLOC -I $(KEYSTONE_SDK)/include \
